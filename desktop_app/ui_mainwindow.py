...
class Ui_HealthyFork(object):
    def setupUi(self, HealthyFork):
        ...
        self.label_2.setGeometry(QRect(120, 10, 341, 31))
        ...
        self.label_8.setStyleSheet(u"background-color: #01579b; color: #4a148c;")
        self.label_8.setScaledContents(True)
        self.label_14 = QLabel(self.tab)
        self.label_14.setObjectName(u"label_14")
        self.label_14.setGeometry(QRect(0, 381, 571, 20))
        self.label_14.setPixmap(QPixmap(u"../../../Downloads/hand-drawn-abstract-blue-leaves-pattern/5570734.jpg"))
        self.gt = QPushButton(self.tab)
        self.gt.setObjectName(u"gt")
        self.gt.setGeometry(QRect(70, 190, 91, 24))
        self.gt.setStyleSheet(u"background-color: #f57f17 ; color:white; border: 0px;")
        self.go = QPushButton(self.tab)
        self.go.setObjectName(u"go")
        self.go.setGeometry(QRect(70, 350, 91, 24))
        self.go.setStyleSheet(u"background-color: #e65100 ; color:white; border: 0px;")
        self.gp = QPushButton(self.tab)
        self.gp.setObjectName(u"gp")
        self.gp.setGeometry(QRect(400, 350, 91, 24))
        self.gp.setStyleSheet(u"background-color: #ffd600 ; color:white; border: 0px;")
        self.gr = QPushButton(self.tab)
        self.gr.setObjectName(u"gr")
        self.gr.setGeometry(QRect(400, 190, 91, 24))
        self.gr.setStyleSheet(u"background-color: #ff6f00 ; color:white; border: 0px;")
        ...
        self.label.setGeometry(QRect(0, 0, 691, 271))
        self.label.setPixmap(QPixmap(u"../../../Downloads/ABSTRACT_COLORFUL_BACKGROUND_01.jpg"))
    ...
    def retranslateUi(self, HealthyFork):
        ...
        self.label_2.setText(QCoreApplication.translate("HealthyFork", u"Datos relacionados Respiraci\u00f3n", None))
        ...
        self.gt.setText(QCoreApplication.translate("HealthyFork", u"Gr\u00e1fica", None))
        self.go.setText(QCoreApplication.translate("HealthyFork", u"Gr\u00e1fica", None))
        self.gp.setText(QCoreApplication.translate("HealthyFork", u"Gr\u00e1fica", None))
        self.gr.setText(QCoreApplication.translate("HealthyFork", u"Gr\u00e1fica", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("HealthyFork", u"Respiraci\u00f3n", None))
        self.label_9.setText("")
        self.label_10.setText(QCoreApplication.translate("HealthyFork", u"Datos relacionados a IMC", None))
